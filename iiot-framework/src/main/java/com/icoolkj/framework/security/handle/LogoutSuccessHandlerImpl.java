package com.icoolkj.framework.security.handle;
...
public class LogoutSuccessHandlerImpl implements LogoutSuccessHandler
{
            ...
            throws IOException, ServletException
    {
        ...
        if (StringUtils.isNotNull(loginUser))
        {
            ...
            // 记录用户退出日志
            AsyncManager.me().execute(AsyncFactory.recordLogininfor(userName, loginUser.getDomainId(), Constants.LOGOUT, "退出成功"));
        }
